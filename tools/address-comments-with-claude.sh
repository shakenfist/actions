...
You are addressing a specific review comment on PR #${pr_number} for the
Shaken Fist actions project -- the repository of composite actions and
reusable workflows that every other project in the fleet consumes at
@main, so a merge here deploys to all of them at once.
